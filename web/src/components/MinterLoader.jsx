...
function MinterLoaderPlaceholderImage() {
  const imageSrc1X = "/images/ImpactX-items/question-gray-lg.png"
  const imageSrc2X = "/images/ImpactX-items/question-gray-lg@2x.png"
  ...
  return (
    ...
    >
      <img src={imageSrc1X} srcSet={imageSrcSet} alt="Mint NFT's for Donation" />
    </div>
  )
}
...
function getImageSrc(kind, is2X) {
  ...
  return `/images/ImpactX-items/${parameterize(kindName)}-blue-lg${
    is2X ? "@2x" : ""
  }.png`
  // return 'https://en.wikipedia.org/wiki/File:FORD,_Gerald_(signed_check).jpg'
}

 ...
 * Storefront Service
 * 
 * Service class used to execute scripts & transactions on the Flow blockchain to buy & sell Flow-ImpactX. 
...
class StorefrontService {
  ...
  buy = (account: string, itemID: number) => {
    ...
    const transaction = fs
      ...
      .replace(ImpactXItemsPath, fcl.withPrefix(this.minterAddress))
      .replace(storefrontPath, fcl.withPrefix(this.storefrontAddress))

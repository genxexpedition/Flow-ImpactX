...
import { deployImpactXItems, setupImpactXItemsOnAccount } from "./ImpactX-items";

/*
 * Deploys ImpactXItems and NFTStorefrontV2 contracts to ImpactXAdmin.
...
export const deployNFTStorefront = async () => {
	...
	return deployContractByName({ to: ImpactXAdmin, name: "NFTStorefrontV2" });
};
...
export const setupStorefrontOnAccount = async (account) => {
	// Account shall be able to store Flow-ImpactX
	await setupImpactXItemsOnAccount(account);

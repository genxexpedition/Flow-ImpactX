...
describe("Emulator + dev-wallet tests", () => {
  describe("Scenarios that do not interact with Flow-ImpactX", () => {
    beforeEach(() => {
    ...
    it("logs in as admin", () => {
      ...
      cy.get('input[placeholder="Enter Password"]').type("ImpactXItems");
  ...
  describe("Scenarios that involve minting Flow-ImpactX", () => {
    beforeEach(() => {
      cy.visit("http://localhost:3001/");
    });
